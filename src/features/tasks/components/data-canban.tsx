  ...
  const onDragEnd = useCallback(
    (result: DropResult) => {
      ...
      setTasks((prevTasks) => {
        ...
        // If there's no moved task (shouldn't happen, but just in case), return previous state
        if (!movedTask) {
          console.error("Kaynak dizininde görev bulunamadı");
          return prevTasks;
        }
        ...
        // Trigger the onChange handler with the updates
